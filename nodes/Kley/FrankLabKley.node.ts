	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				default: 'probe',
				options: [
					{ name: 'Animated Loop', value: 'animated' },
