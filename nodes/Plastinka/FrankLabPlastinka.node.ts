		...
		properties: [
			...
			},
			{
				...
				options: [
					...
					{ name: 'Enhance Dialogue', value: 'enhance_dialogue' },
					...
					{ name: 'Spectrogram', value: 'spectrogram' },
					{ name: 'Speed', value: 'speed' },
					{ name: 'Stereo Tools', value: 'stereo_tools' },
					{ name: 'Strip Tags', value: 'strip_tags' },
					{ name: 'Trim', value: 'trim' },
					{ name: 'Waveform Image', value: 'waveform_image' },
